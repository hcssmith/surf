...
#define DMENU_FONT "Source Code Pro:pixelsize=30:antialias=true:autohint=true"

/* SETPROP(readprop, setprop, prompt, font)*/
#define SETPROP(r, s, p, d) { \
...
static Key keys[] = {
	...
	{ MODKEY,                GDK_KEY_g,      spawn,      SETPROP("_SURF_URI", "_SURF_GO", PROMPT_GO, DMENU_FONT) },
